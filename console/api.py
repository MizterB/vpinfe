...
class ApiClient:
    ...
    def owned(self, ids: list[str]) -> dict:
        return self._post("/library/owned", {"ids": list(ids)})
    ...
    def make_launcher_default(self, launcher_id: str) -> dict:
        return dict(self._post(f"/launchers/{launcher_id}/default", {}) or {})
